...
const socketIoModules = {
	ios: {
		url: 'https://github.com/appcelerator-modules/titanium-socketio/releases/download/v3.0.0-iphone/ti.socketio-iphone-3.0.0.zip',
		sha1: '77d3219c0c9672f45ad4f05dd72747837649357c'
	},
	android: {
		url: 'https://github.com/appcelerator-modules/titanium-socketio/releases/download/android-v4.0.0/ti.socketio-android-4.0.0.zip',
		sha1: 'fa927b633c44e35914812a0e5c1a7a1aa13d57be'
	}
};
