...
ProjectManager.prototype.modifyTitaniumXcconfig = async function (xcconfigPath) {
	await fs.move(xcconfigPath, `${xcconfigPath}.bak`); // create backup of original
	...
	return fs.writeFile(xcconfigPath, `TITANIUM_SDK_VERSION = ${sdkVersion}
	TITANIUM_SDK = ~/Library/Application Support/titanium/mobilesdk/osx/$(TITANIUM_SDK_VERSION)
	TITANIUM_BASE_SDK = "$(TITANIUM_SDK)/iphone/include"
	TITANIUM_BASE_SDK2 = "$(TITANIUM_SDK)/iphone/Classes"
	TITANIUM_BASE_SDK3 = "$(TITANIUM_SDK)/iphone/include/APSHTTPClient"
